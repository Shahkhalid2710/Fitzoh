...
import com.applocum.fitzoh.ui.home.fitzohvideolibrary.activities.EveryDayBllishActivity
...
class RecyclerAdapterRawCategory(context: Context,list:ArrayList<CategoryRaw>) :RecyclerView.Adapter<RecyclerAdapterRawCategory.CategoriesHolder>(){
   ...
   var mList=list
    ...
    override fun onBindViewHolder(holder: CategoriesHolder, position: Int) {
        ...
        holder.itemView.rvRaw.adapter=
            RecyclerAdapterCategories(
                mContext,
                categoryRaw.mylist
            )
        ...
        holder.itemView.tvViewmoreCategory.setOnClickListener {
           val intent=Intent(mContext,
               EveryDayBllishActivity::class.java)
