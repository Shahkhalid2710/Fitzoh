package com.applocum.fitzoh.ui.home.createcalender.activities
...
import com.applocum.fitzoh.ui.home.createcalender.adapters.RecyclerAdapterSession
import com.applocum.fitzoh.ui.home.createcalender.adapters.RecyclerAdapterSessionTrainer
...
class SelectCalenderActivity : AppCompatActivity(), OnDateSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvType.adapter =
            RecyclerAdapterSession(
                this,
                mListSessionCategory,
                object :
                    RecyclerAdapterSession.CellClickListener {
                    override fun onCellClickistener(myobject: SessionCategory, position: Int) {
                        ...
                        val recyclerAdapterSessionTrainer =
                            RecyclerAdapterSessionTrainer(
                                this@SelectCalenderActivity,
                                mListSessionTrainer,
                                object :
                                    RecyclerAdapterSessionTrainer.CellClickListener {
                                    override fun onCellClickistener(
                                        myobject: Trainer,
                                        position: Int
                                    ) {
