...
class RecyclerAdapterVideoLibrary(context: Context, list:ArrayList<Fitzohvideo>, private var cellClickListener:CellClickListener):RecyclerView.Adapter<RecyclerAdapterVideoLibrary.VideolibraryHolder>(){
