package com.applocum.fitzoh.ui.home.wholestichealthandwellness.basicpackages.activities
...
class BasicPackageFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        v.rvBasicpackage.adapter= activity?.let {
            RecyclerAdapterBasicPackages(
                ...
                object :
                    ...
                    override fun onCellClickistener(myobject: Packages, position: Int) {
                        val intent = Intent(
                            activity,
                            NutritionistCounsellorsActivity::class.java
                        )
