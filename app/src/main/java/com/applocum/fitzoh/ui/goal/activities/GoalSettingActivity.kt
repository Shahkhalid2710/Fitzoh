...
class GoalSettingActivity : AppCompatActivity(), View.OnClickListener,
    PopupMenu.OnMenuItemClickListener {
    var selectPositiveHabit:String = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cbWakeup.setOnCheckedChangeListener(CompoundButton.OnCheckedChangeListener { compoundButton, b ->
            if (b) {
        ...
        cbSelfConfidence.setOnCheckedChangeListener(CompoundButton.OnCheckedChangeListener { compoundButton, b ->
            if (b) {
        ...
        cbSickness.setOnCheckedChangeListener(CompoundButton.OnCheckedChangeListener { compoundButton, b ->
            if (b) {
    ...
    fun maxrange(): Int {
        ...
        val i: Int = Integer.valueOf(kg!!.toInt())
        return i
    }
    ...
    private fun displayBMI(bmi: Float) {
        ...
        tvBmi.setText("$bmi")
        tvOverWeight.setText(bmiLabel)
    }

    fun validategoal(bmi:String,bmitype:String,weightrange:String,targetweight:String,fitnessgoal:String,positivehabit:String):Boolean
    {
        if (bmi.isEmpty()) {
