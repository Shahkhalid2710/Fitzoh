...
import com.applocum.fitzoh.ui.home.wholestichealthandwellness.adapters.RecyclerAdapterNutritionists
...
class NutritionistCounsellorsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvNutritionist.adapter=
            RecyclerAdapterNutritionists(
                this,
                mListAllNutritionists,
                object :
                    RecyclerAdapterNutritionists.CellClickListener {
                    override fun onCellClickistener(myobject: Counsellor, position: Int) {
                        val intent = Intent(
                            this@NutritionistCounsellorsActivity,
